...
const future = new Date(2037, 10, 30, 20, 20);

// convert thành number: đây là timestamp (miliseconds)
// mỗi khi chúng ta thực hiện calculations với dates thì phải convert thành timestamp và thực hiện calculations, sau đó convert lại như cũ
const futureNum = +future;
console.log(future, futureNum);
...
/* 
  ...
  Nếu chúng ta muốn chính xác, cũng như trong một số trường hợp đặc biệt (Timezone...) thì nên sử dụng library cho dễ >> MOMENT.JS
*/
